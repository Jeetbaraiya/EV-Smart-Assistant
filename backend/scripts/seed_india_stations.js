...
const ownerIds = [3, 4, 5]; // yash, abc, krutarth
...
async function seed() {
  try {
    ...
    console.log('Starting seeding of 45 Indian stations...');
    
    for (let i = 0; i < stationsData.length; i++) {
      const station = stationsData[i];
      const ownerId = ownerIds[Math.floor(i / 15)]; // 0-14 -> ownerIds[0], 15-29 -> ownerIds[1], 30-44 -> ownerIds[2]
